...
userRoutes.get('/users', userController.AllUsers);
...
userRoutes.put('/update/:userId', AutorizationMiddleawe, uploadUser.single('userImg'), userController.updateUser); // metodo deve ser put
